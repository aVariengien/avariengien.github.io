...
permalink: mindware
thumbnail-img: /assets/img/mindware/bely.png
---
...
It is already late, and I have to wake up early tomorrow. Turning on my phone or opening the light to write in my notebook will reset my melatonin level, and I'd have to spend an additional 30 minutes before falling asleep.
...
![img1](/assets/img/mindware/perforated_page.png){: .center width="50%"}

## Solution 2: \~2019-2023. Wooden frame and a robust alphabet

To solve the friction of perforation, I created a fixed frame made of sticks with horizontal climbing tapes. The frame would rest on top of my open notebook, and I would leave my pen in the first empty line. At night, I would find the line with the pen, write the idea, and place the pen in the empty line below.

![img1](/assets/img/mindware/alphabet.png){: .center width="50%"}
...
To store an idea at night, I create a mental pointer to the idea and drop it near the next empty landmark along the path. Good pointers are characters that interact with the environment in one way or another. For instance, if I want to remember to send a message to a friend, I’ll imagine this friend in the clearing with a letter in their hands, putting a nail in the trunk of a tree to display it.
...
It is a clear improvement over past solutions, as I don’t even have to have a notebook around to use it.
